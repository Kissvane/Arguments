...
namespace Arguments
{
    ...
    public class Character
    {
        ...
        public Character(string name, int ? lifetime = null)
        {
            Name = name;
        ...
        public async Task StartLife()
        {
            ...
            //I don't need to cry for my friends anymore
            //because i'm dead
        ...
        public void ChooseEnemiesAndFriends(List<Character> characters, int enemiesNumber = -1, int friendsNumber = -1)
        {
            ...
            temp.Remove(this);
            //choose enemies
            ChooseEnemies(temp, enemiesNumber);
            //choose friends
            ChooseFriends(temp, friendsNumber);
        }

        public void ChooseEnemies(List<Character> characters, int enemiesNumber = -1)
        {
            ...
            if (enemiesNumber == -1)
            {
                enemiesNumber = rand.Next(0, PossibleEnemies.Count);
            }
            else
            {
        ...
        public void ChooseFriends(List<Character> characters, int friendsNumber = -1)
        {
            ...
            if (friendsNumber == -1)
            {
                friendsNumber = rand.Next(0, Friendable.Count);
            }
            else
            {
